...
# -*- coding: utf-8 -*-
"""
@file:formalEnvironment.py
@time:2017/2/22 0022 14:55
"""
...
#web1
env.hosts = ['139.217.15.186:22']
#web2
#env.hosts = ['139.217.26.253:22']
#web3
...
def restartTomcat():
    ...
    time.sleep(5)
    run('. /etc/profile &&  su jumpserver -l -c "/opt/workspace/tomcat/bin/startup.sh" ')
